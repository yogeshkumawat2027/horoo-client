...
export default function PropertyDetails({ 
  ...
  return (
    <div>
      {/* flat Details */}
      {(flatType?.length > 0 || availableFor?.length > 0 || roomSize) && (
      <div className="bg-white p-4 md:p-6 border-t border-gray-100">
        {/* flat Type, Available For, Flat Size - All in one line */}
        <div className="flex flex-wrap items-center gap-4 md:gap-6 mb-2">
          ...
          {flatType && flatType.length > 0 && (
            <div className="flex md:flex-col items-center gap-2"> 
              ...
              <div className="text-xs md:text-sm font-semibold text-gray-700">Flat Type:</div>
              <div className="flex flex-wrap gap-1.5">
                {flatType.map((type, idx) => (
                  <span 
                    key={idx} 
          ...
          {roomSize && (
            <div className="flex md:flex-col items-center gap-2">
              ...
              <span className="text-xs md:text-sm font-semibold text-gray-700">Flat Size:</span>
