  ...
  const fetchHotels = async () => {
    ...
    try {
      ...
      const url = hasFilters 
        ? `${API}/hotel/filter-for-user?${params.toString()}`
        : `${API}/hotel-for-user`;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-4 hidden md:block">
            ...
            <p className="text-base md:text-lg text-gray-600 mb-4 max-w-2xl mx-auto">
              Discover comfortable and affordable hotels across India
            </p>
          </div>
          ...
          <div className="flex items-center justify-between mb-4 md:mb-6">
            <div>
              <h2 className="text-xl md:text-3xl font-bold text-gray-900 flex items-center gap-2 md:gap-3">
               {/* <span className="text-orange-600">{hotels.length}</span>  */}
                <span>Hotels</span>
              </h2>
              <p className="text-xs md:text-sm text-gray-600 mt-1">
                {hasActiveFilters ? 'Filtered results' : 'All available hotels'}
              </p>
            </div>
            {/* <button
              onClick={fetchHotels}
