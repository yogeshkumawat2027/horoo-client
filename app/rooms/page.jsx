  ...
  const fetchRooms = async () => {
    ...
    try {
      ...
      const url = hasFilters 
        ? `${API}/rooms/filter-for-user?${params.toString()}`
        : `${API}/rooms-for-user`;
          ...
          <div className="max-w-6xl mx-auto mt-3 flex justify-center">
            <button
              onClick={() => {
                ...
                if (areaName) {
                  router.push(`/rooms/map-search?area=${encodeURIComponent(areaName)}`);
                } else {
                  router.push('/rooms/map-search');
                }
              }}
          ...
          <div className="flex items-center justify-between mb-4 md:mb-6">
            <div>
              <h2 className="text-xl md:text-3xl font-bold text-gray-900 flex items-center gap-2 md:gap-3">
               {/* <span className="text-orange-600">{rooms.length}</span>  */}
                <span>Rooms</span>
              </h2>
